...
export default function MainAdmin() {
  const stats = [
    { name: 'Total Users', value: '2,847', change: '+12%', icon: Users, color: 'blue' },
    { name: 'Products', value: '1,234', change: '+8%', icon: Package, color: 'green' },
    { name: 'Orders', value: '567', change: '+15%', icon: ShoppingCart, color: 'purple' },
    { name: 'Revenue', value: '$89,234', change: '+22%', icon: DollarSign, color: 'yellow' },
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <div>
              <h3 className="text-lg font-semibold bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 bg-clip-text text-transparent">Sales Overview</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Revenue and order trends</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <div>
              <h3 className="text-lg font-semibold bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 bg-clip-text text-transparent">Category Distribution</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Product categories breakdown</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 mt-4">
            {categoryData.map((entry, index) => (
              <div key={index} className="flex items-center space-x-2 p-2 rounded-lg bg-gray-50/50 dark:bg-gray-700/30">
                <div 
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">{entry.value}%</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button className="flex items-center space-x-3 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-blue-600 dark:text-blue-400">View and edit accounts</p>
            </div>
          </button>
          <button className="flex items-center space-x-3 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/30 transition-colors">
            ...
            <div className="text-left">
              <p className="font-medium text-green-900 dark:text-green-100">System Settings</p>
              <p className="text-sm text-green-600 dark:text-green-400">Configure platform</p>
            </div>
          </button>
          <button className="flex items-center space-x-3 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-colors">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-purple-600 dark:text-purple-400">Detailed reports</p>
            </div>
          </button>
        </div>
      </motion.div>
